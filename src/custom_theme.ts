...
export const customTheme: CustomThemeConfig = {
  ...
  properties: {
    ...
    /* =~= Theme Colors  =~= */
    /* primary | #84d6ff */
    '--color-primary-50': '237 249 255' /* ⬅ #edf9ff */,
    '--color-primary-100': '230 247 255' /* ⬅ #e6f7ff */,
    '--color-primary-200': '224 245 255' /* ⬅ #e0f5ff */,
    '--color-primary-300': '206 239 255' /* ⬅ #ceefff */,
    '--color-primary-400': '169 226 255' /* ⬅ #a9e2ff */,
    '--color-primary-500': '132 214 255' /* ⬅ #84d6ff */,
    '--color-primary-600': '119 193 230' /* ⬅ #77c1e6 */,
    '--color-primary-700': '99 161 191' /* ⬅ #63a1bf */,
    '--color-primary-800': '79 128 153' /* ⬅ #4f8099 */,
    '--color-primary-900': '65 105 125' /* ⬅ #41697d */,
    /* secondary | #b44641 */
    '--color-secondary-50': '244 227 227' /* ⬅ #f4e3e3 */,
    '--color-secondary-100': '240 218 217' /* ⬅ #f0dad9 */,
    '--color-secondary-200': '236 209 208' /* ⬅ #ecd1d0 */,
    '--color-secondary-300': '225 181 179' /* ⬅ #e1b5b3 */,
    '--color-secondary-400': '203 126 122' /* ⬅ #cb7e7a */,
    '--color-secondary-500': '180 70 65' /* ⬅ #b44641 */,
    '--color-secondary-600': '162 63 59' /* ⬅ #a23f3b */,
    '--color-secondary-700': '135 53 49' /* ⬅ #873531 */,
    '--color-secondary-800': '108 42 39' /* ⬅ #6c2a27 */,
    '--color-secondary-900': '88 34 32' /* ⬅ #582220 */,
    /* tertiary | #c0b6b4 */
    ...
    '--color-surface-300': '166 167 167' /* ⬅ #a6a7a7 */,
    '--color-surface-400': '100 100 101' /* ⬅ #646465 */,
    '--color-surface-500': '33 34 35' /* ⬅ #212223 */,
    '--color-surface-600': '30 31 32' /* ⬅ #1e1f20 */,
    '--color-surface-700': '25 26 26' /* ⬅ #191a1a */,
    '--color-surface-800': '20 20 21' /* ⬅ #141415 */,
    '--color-surface-900': '16 17 17' /* ⬅ #101111 */
  }
};
