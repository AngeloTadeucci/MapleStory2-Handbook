...
<div class="mx-4 rounded-xl px-5 pb-10 pt-2 lg:m-auto lg:w-3/4">
	...
	{#each paginatedSource as item}
		<a
			...
			class="unstyled flex items-center border-b border-surface-300 py-2 last:border-none hover:bg-surface-hover-token"
		>
